...
/**
 * Test class for Dazzle\Http\Http.
 */
class HttpTest extends TestCase
{
	...
	{
		$this->expectException(\InvalidArgumentException::class);
		$this->expectExceptionMessage('A string or Dazzle\Uri\UriInterface object must be provided, a "array" was provided.');
